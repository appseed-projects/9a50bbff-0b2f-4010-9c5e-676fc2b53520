...
- Timestamp: `2022-06-10 01:10`
- Build ID: `9a50bbff-0b2f-4010-9c5e-676fc2b53520`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/9a50bbff-0b2f-4010-9c5e-676fc2b53520.git
$ cd 9a50bbff-0b2f-4010-9c5e-676fc2b53520
```
